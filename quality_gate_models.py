...
class RegimeConfig:
    ...
    family_regime_map: Dict[str, str] = field(default_factory=lambda: {
        ...
        "oi_reversal":                 "any",
        # 18 strategy mapping
        "macd_trend_continuation":     "trend_only",
        "ema_pullback_buy":            "trend_only",
        "obv_accumulation_breakout":   "trend_only",
        "high_vol_breakout":           "trend_only",
        "momentum_chasing":            "trend_only",
        "vwap_reversion_fade":         "range_only",
        "range_boundary_fade":         "range_only",
        "liquidity_sweep_hunt":        "range_only",
        "hft_order_flow_momentum":     "any",
        "high_vol_breakdown":          "trend_only",
        "short_momentum_chase":        "trend_only",
        "oversold_bounce":             "range_only",
        "bearish_trend_continuation":  "trend_only",
        "ema_pullback_sell":           "trend_only",
        "obv_distribution_breakdown":  "trend_only",
        "mean_reversion_squeeze":      "range_only",
    })
